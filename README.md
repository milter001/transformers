...
# transformers源码阅读互助小组

为了确保小组阅读活动顺利进行，制定阅读章程如下:


### 1，每周确定一个主题、问题或者某个具体的文件

### 2，小组成员各自研读，有疑问的地方在代码处注释说明，并及时提交。

### 3，每个主题指定一个负责人，负责人应及时解答小组成员的疑问，形式以注释为主。其他成员也可进行解答，但负责人应进行兜底。

### 4，周末，根据需要决定是否组织一次哔哩哔哩直播或者腾讯会议，由负责人集中解答大家疑惑。视频上传哔哩哔哩存档。

### 5，负责人原则上实行随机轮流制，无法接受者可自由退群。

### 6，主题或者问题可每周群内自由讨论，最后民主决定。
