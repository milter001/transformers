...
### 1、每个人及时更新自己要阅读的文件，如果是一个主题，可以是多个文件。

### 2、注明文件路径、阅读人、阅读时间、产出形式以及自己核心关注的问题，产出形式主要有以下几种：
...
| src/transformers/bert/modeling_bert.py | 2021-03-15至2021-03-22 | eshaoliu | 详细注释 | bert的multihead_attention |
